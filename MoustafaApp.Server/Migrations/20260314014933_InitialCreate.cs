        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhotoBrand = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Versace", "assets/images/Versace.png" },
                    { 2, "ZARA", "assets/images/Zara.png" },
                    { 3, "GUCCI", "assets/images/Gucci.png" },
                    { 4, "PRADA", "assets/images/Prada.png" },
                    { 5, "Calvin Klein", "assets/images/CalvinKlein.png" }
                });
            ...
            migrationBuilder.InsertData(
                table: "ProductColors",
                columns: new[] { "ColorId", "ColorName", "ProductId" },
                values: new object[,]
                {
                    { 1, "Navy", 1 },
                    { 2, "Olive", 1 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "assets/images/image-D1.png", 1 },
                    { 2, "assets/images/image-D2.png", 1 },
                    { 3, "assets/images/image-D3.png", 1 },
                    { 4, "https://example.com/images/skinny-jeans.jpg", 2 },
                    { 5, "https://example.com/images/skinny-jeans-side.jpg", 2 },
                    { 6, "https://example.com/images/skinny-jeans-back.jpg", 2 },
                    { 7, "https://example.com/images/checkered-shirt.jpg", 3 },
                    { 8, "https://example.com/images/checkered-shirt-side.jpg", 3 },
                    { 9, "https://example.com/images/checkered-shirt-back.jpg", 3 },
                    { 10, "https://example.com/images/sleeve-striped.jpg", 4 },
                    { 11, "https://example.com/images/sleeve-striped-side.jpg", 4 },
                    { 12, "https://example.com/images/sleeve-striped-back.jpg", 4 }
                });
